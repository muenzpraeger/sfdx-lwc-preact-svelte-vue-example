...
class List extends _ {
  constructor(...args) {
    super(...args);

    _defineProperty(this, "ref", p());
  ...
  render() {
    if (this.state.accounts) {
      const listItems = this.state.accounts.map(account => v("li", {
        style: {
          cursor: "pointer"
        },
      ...
      return v("div", null, this.props.title, v("ul", {
        ref: this.ref
      }, listItems));
    }
...
class App extends _ {
  render(props) {
    return v("div", {
      id: "app"
    }, "Data from outer property: ", props.title, v("br", null), v("br", null), v(List, null));
  }
